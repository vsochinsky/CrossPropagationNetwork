...
NeuralNet::NeuralNet(){
	...
	config_file >> temp >> decrease_speed;
	config_file >> temp >> forgetting_force;
	config_file >> temp >> teach_force;
...
void NeuralNet::ActuatorIterate(){ ///this function will be spammed dy main one, it choose random neuron by itself
	...
	for(i = 0; i < output_layer_size; i++){
		...
		output_layer[i].ExcitementDecrease(decrease_speed);///decreasing BOTH excitements
	}
	...
	for(i = 0; i < hidden_layer_size; i++){
		...
		hidden_layer[i].ExcitementDecrease(decrease_speed);///decreasing BOTH excitements
	}
}
...
void NeuralNet::SensorIterate(){ ///this function will be spammed dy main
	...
	for(i = 0; i < input_layer_size; i++){
		...
		input_layer[i].ExcitementDecrease(decrease_speed);///decreasing BOTH excitements
	}
